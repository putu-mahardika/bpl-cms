            ...
            <table class="table align-items-center table-bordered" id="table_handling_1">
                ...
                <?php if (count($dataDtlQuoShipmentHandlingCosts) > 0) { ?>
                        <?php foreach ($dataDtlQuoShipmentHandlingCosts as $key => $val) { ?>
                            <?php if ($val['handling_turunan'] == 1) { ?>
                                <tr>
                                    ...
                                    <td class="px-3">
                                        <input type="hidden" class="form-control text-right inputmask_currency" id="handling_unit_cost_1" name="handling_unit_cost_1" placeholder="0" value="<?php echo $val['unit_cost'] ?>">
                                    ...
                                    <td class="px-3">
                                        <input type="hidden" class="form-control text-right inputmask_currency" id="handling_total_cost_1" name="handling_total_cost_1" placeholder="0" disabled value="<?php echo $val['total_cost'] ?>">
                    ...
                    <?php } else {?>
                        <tr>
                            <td class="px-3">
                                <input type="hidden" class="form-control" id="handling_id_next" name="handling_id_1" placeholder="Masukkan nama biaya handling..." value="<?php echo $val['id'] ?>">
                                <input type="text" class="form-control" id="handling_name_1" name="handling_name_1" placeholder="Masukkan nama biaya handling..." value="<?php echo $val['handling_description'] ?>">
                            </td>
                            <td class="px-3">
                                <input type="text" class="form-control text-right inputmask_currency" id="handling_qty_1" name="handling_qty_1" placeholder="0">
                        ...
                        <?php foreach ($dataDtlQuoShipmentHandlingCosts as $key => $val) { ?>
                            ...
                            <?php if ($val['handling_turunan'] == 2) { ?>
                                <tr>
                                    ...
                                    <td class="px-3">
                                        <input type="hidden" class="form-control text-right inputmask_currency" id="handling_unit_cost_next" name="handling_unit_cost_next" placeholder="0" value="<?php echo $val['unit_cost'] ?>">
                                    ...
                                    <td class="px-3">
                                        <input type="hidden" class="form-control text-right inputmask_currency" id="handling_total_cost_next" name="handling_total_cost_next" placeholder="0" disabled value="<?php echo $val['total_cost'] ?>">
