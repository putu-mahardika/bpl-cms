...
<head>
  ...
  <title>Edit Negara - PT Berkah Permata Logistik</title>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          ...
          <a href="negara.php" style="margin-right:20px;"><i class="far fa-arrow-alt-circle-left fa-2x" title="kembali"></i></a>
            <h1 class="h3 mb-0 text-gray-800">Edit Negara</h1>
            <!--<ol class="breadcrumb">
          ...
          <?php
            $id = $_GET['id'];
            $fetch = mysqli_query($koneksi, "select * from master_negara where Id='$id'");
          ...
          <div class="card-body">
              <form class="form group" method="post" action="../../config/process.php">
                ...
                <label>Nama :</label>
                <input type="text" class="form-control form-control-sm mb-3" value="<?php echo $data['Nama'];?>" name="namaNegara" minlength="3" maxlength="30" required>
                ...
                <input type="submit" value="Submit" name="editNegara" class="btn btn-md btn-primary " style="width:77%;">
              </form>
            </div>
