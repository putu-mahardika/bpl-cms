...
<head>
  ...
  <title>Tambah Status - PT Berkah Permata Logistik</title>
...
<body id="page-top">
      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-start mb-4">
            <a href="dashboard-admin.php" style="margin-right:20px;"><i class="far fa-arrow-alt-circle-left fa-2x" title="kembali"></i></a>
          ...
          <div class="card-body">
              <form class="form group" method="post" action="../../config/process.php">
                ...
                <input type="text" class="form-control form-control-sm mb-3" name="l_pass" id="l_pass" required>
                <label>Konfirmasi Password Lama :</label>
                <input type="text" class="form-control form-control-sm mb-3" name="k_pass" id="k_pass" onchange="changeValue()" required>
                <label>Password Baru :</label>
				 <input type="text" class="form-control form-control-sm mb-3" name="b_pass" id="b_pass" required>
                ...
                <input type="submit" value="Submit" name="editPassword" id="submit" class="btn btn-md btn-primary " style="width:77%;">
              </form>
            </div>
  ...
  <script type="text/javascript">
	function changeValue(){
		var a = document.getElementById('l_pass').value;
		var b = document.getElementById('k_pass').value;
		var c = document.getElementById('k_pass');
