      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-start mb-4">
            <a href="status.php" style="margin-right:20px;"><i class="far fa-arrow-alt-circle-left fa-2x" title="kembali"></i></a>
          ...
          <div class="card-body">
              ...
              <form class="form group" method="post" action="../../config/process.php">
                ...
                <input type="submit" value="Submit" name="inputStatus" class="btn btn-md btn-primary " style="width:77%;">
              </form>
            </div>
