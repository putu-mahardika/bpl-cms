...
<head>
  ...
  <title>Edit Status Shipment - PT Berkah Permata Logistik</title>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          ...
          <a href="statusShipment.php" style="margin-right:20px;"><i class="far fa-arrow-alt-circle-left fa-2x" title="kembali"></i></a>
            <h1 class="h3 mb-0 text-gray-800">Edit Status Shipment</h1>
            <!--<ol class="breadcrumb">
          ...
          <div class="card-body">
            ...
            <form class="form group" method="post" action="../../config/controller/statusShipmentController.php">
              ...
              <label>Nama :</label>
              <input type="text" class="form-control form-control-sm mb-3" name="nama" minlength="3" maxlength="50" value ="<?php echo $data['nama'];?>" required>
              <label>Aktif :</label>
