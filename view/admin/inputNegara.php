...
<head>
  ...
  <title>Tambah Negara - PT Berkah Permata Logistik</title>
      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-start mb-4">
            ...
            <h1 class="h3 mb-0 text-gray-800">Tambah Negara</h1>
            <!--<ol class="breadcrumb">
          ...
          <div class="card-body">
              <form class="form group" method="post" action="../../config/process.php">
                ...
                <label>Nama :</label>
                <input type="text" class="form-control form-control-sm mb-3" name="namaNegara" minlength="3" maxlength="30" required>
                ...
                <input type="submit" value="Submit" name="inputNegara" class="btn btn-md btn-primary " style="width:77%;">
              </form>
            </div>
