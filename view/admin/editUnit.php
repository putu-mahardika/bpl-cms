...
<head>
  ...
  <title>Edit Unit - PT Berkah Permata Logistik</title>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          ...
          <?php
            $id = $_GET['id'];
            $fetch = mysqli_query($koneksi, "select * from master_unit where id='$id'");
          ...
          <div class="card-body">
            ...
            <form class="form group" method="post" action="../../config/controller/unitController.php">
              ...
              <input type="submit" value="Submit" name="editUnit" class="btn btn-md btn-primary " style="width:77%;">
            </form>
          </div>
