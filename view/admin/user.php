...
<head>
  ...
  <title>User - PT Berkah Permata Logistik</title>
...
<body id="page-top">
      ...
      <li class="nav-item active">
        ...
        <div id="collapseBootstrap" class="collapse show" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item active" href="user.php">User Pengguna</a>
      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">List Akun User</h1>
                      ...
                      <?php
                        ...
                        <?php } else{ ?>
                          ...
                          <?php if ($data['isSales'] == 1) { ?>
                            ...
                            <?php } ?>
                          <?php if ($data['isVmTrucking'] == 1) { ?>
                            <span class="badge badge-success">VM Trucking</span>
                           <?php } ?>
                           <?php if ($data['isVMShipment'] == 1) { ?>
                            <span class="badge badge-info">VM Shipment</span>
                           <?php } ?>
                          </td>
                        <?php } ?>
                        <?php 
                        ...
                        <?php } ?>
                          ...
                          <td><a href="editUser.php?id=<?php echo $data['UserId']?>" class="btn btn-warning">
  ...
  <!--<script src="https://cdn.datatables.net/plug-ins/1.10.21/sorting/date-dd-MMM-yyyy.js"></script>-->
