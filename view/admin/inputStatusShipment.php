...
<head>
  ...
  <title>Tambah Status Shipment - PT Berkah Permata Logistik</title>
      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-start mb-4">
            ...
            <h1 class="h3 mb-0 text-gray-800">Tambah Status Shipment</h1>
            <!--<ol class="breadcrumb">
          ...
          <div class="card-body">
              ...
              <form class="form group" method="post" action="../../config/controller/statusShipmentController.php">
                ...
                <input type="submit" value="Submit" name="inputStatusShipment" class="btn btn-md btn-primary " style="width:77%;">
              </form>
            </div>
