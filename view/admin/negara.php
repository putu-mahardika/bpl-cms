...
<head>
  ...
  <title>Negara - PT Berkah Permata Logistik</title>
      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">List Negara</h1>
            <a class="btn btn-info btn-lg " target="_blank" href="../../export/exportnegara.php"><i class="fas fa-print"></i></a>
            ...
            <div class="col-lg-12">
              <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  ...
                  <a href="inputNegara.php" class="btn btn-primary btn-icon-split">
                    <span class="icon text-white-50">
                      <i class="fas fa-plus"></i>
                    </span>
                    <span class="text">Tambah Negara</span>
                  </a>
                ...
                <div class="table-responsive p-3">
                  ...
                  <table class="table align-items-center table-flush table-hover" id="dataTableHover">
                    ...
                    <?php } ?>	
                        ...
                        <td><a href="editNegara.php?id=<?php echo $data['Id']?>" class="btn btn-warning">
