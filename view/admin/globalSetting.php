              ...
              <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                ...
                <div class="container-fluid" id="container-wrapper">
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">List Global Setting</h1>
                        ...
                        <div class="col-lg-12">
                            <div class="card mb-4">
                                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    ...
                                    <a href="inputGlobalSetting.php" class="btn btn-primary btn-icon-split">
                                        <span class="icon text-white-50">
                                            <i class="fas fa-plus"></i>
                                        </span>
                                        <span class="text">Tambah Global Setting</span>
                                    </a>
                                ...
                                <div class="table-responsive p-3">
                                    <table class="table align-items-center table-flush" id="dataTableHover">
                                        ...
                                        <tbody>
                                            <?php $i = 1; while ($data = mysqli_fetch_array($fetch)) {?>
                                                <tr>
                                                    <td><?php echo $i ?></td>
                                                    ...
                                                    <td>
                                                        <a href="editGlobalSetting.php?code=<?php echo $data['Code'] ?>" class="btn btn-warning">
