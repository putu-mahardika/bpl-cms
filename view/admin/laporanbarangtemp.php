  ...
  <script>
    $(document).ready(() => {
      ...
      dataGrid = $('#gridContainer').dxDataGrid({
        ...
        dataSource: '../../config/reportTempController.php?reportTransaksitemp=true',
        // keyExpr: 'id',
        ...
        columns: [
          ...
          },
          {
            ...
            dataField: 'DetailKotaTujuan'
          },
          {
            caption: 'Total Armada',
            dataField: 'TotalArmada'
          },
          {
            caption: 'Barang',
            dataField: 'Barang'
