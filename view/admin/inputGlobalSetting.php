            ...
            <div id="content">
                ...
                <div class="container-fluid" id="container-wrapper">
                    <div class="d-sm-flex align-items-center justify-content-start mb-4">
                        ...
                        <h1 class="h3 mb-0 text-gray-800">Tambah Global Setting</h1>
                    </div>
                    <div class="card-body">
                        <form class="form group" method="post">
                            <label>Code :</label>
                            <input type="text" class="form-control mb-3 inputmask_code" id="code" value="<?php echo $data['Code']; ?>" name="code" min="3" max="30" placeholder="Isikan Code..." maxlength="6">
                            <label>Val :</label>
                            <textarea class="form-control" name="val" id="val" value="<?php echo $data['val'] ?>" rows="10"></textarea>
                            <label class="mt-3">Description</label>
                            <textarea class="form-control mb-3" name="description" id="description" placeholder="Isikan Description..." value="<?php echo $data['description'] ?>" rows="5"></textarea>
                            <div class="row">
                                <div class="col-md-2">
                                    <input type="reset" value="Reset" class="btn btn-danger w-100">
                                </div>
                                <div class="col-md-10">
                                    <button type="button" class="btn btn-md btn-primary w-100" onclick="createData()">Simpan</button>
                                </div>
                            </div>
                        </form>
                    </div>
    ...
    <script>
        ...
        getValidate = () => {
            if ($('#code').val().length < 3) {
                toastr.error('Kolom Code minimal 3 karakter', 'Required!')
                return true;
            }

            if ($('#code').val() == '' || $('#description').val() == null) {
                toastr.error('Code harus diisi', 'Required!')
                return true;
            }
