<tr>
    ...
    <td class="px-2">
        <input type="text" class="form-control text-right inputmask_currency" id="handling_total_price_next" name="handling_total_price_next" placeholder="0" value="<?php echo $val['total_price'] ?>" disabled>
    </td>
</tr>