<tr>
    ...
    <td class="px-2">
        <input type="text" class="form-control text-right inputmask_currency" placeholder="0" value="<?php echo $data['dtl_quo_shipment_costing_first_price'] ?>" disabled>
    </td>
    <td class="px-2">
        <input type="text" class="form-control text-right inputmask_currency" placeholder="0" value="<?php echo $data['dtl_quo_shipment_costing_next_price'] ?>" disabled>
    </td>
    <td class="px-2">
        <input type="text" class="form-control text-right inputmask_currency" disabled placeholder="0" value="<?php echo $data['dtl_quo_shipment_costing_total_price'] ?>" disabled>
    </td>
    <td class="px-2">
    ...
    <td class="px-2">
        <input type="text" class="form-control text-right inputmask_currency" placeholder="0" value="<?php echo $data['dtl_quo_shipment_pricing_first_price'] ?>" disabled>
    </td>
    <td class="px-2">
        <input type="text" class="form-control text-right inputmask_currency" placeholder="0" value="<?php echo $data['dtl_quo_shipment_pricing_next_price'] ?>" disabled>
    </td>
    <td class="px-2">
        <input type="text" class="form-control text-right inputmask_currency" disabled placeholder="0" value="<?php echo $data['dtl_quo_shipment_pricing_total_price'] ?>" disabled>
    </td>
</tr>