<div class="card-body">
    <div class="row mb-5">
        ...
        <div class="col-md-12 mb-3">
            ...
            <select name="new_sales" id="new_sales" class="form-control" onchange="setSelectNewSales()">
        ...
        <div class="col-md-12">
            <button id="btn_update_sales" class="btn btn-primary w-100 py-2" disabled onclick="updateSales(<?php echo $_GET['id'] ?>)">Simpan</button>
        </div>
    </div>
    <div class="row">
        <div class="col-md-12 mb-3">
        ...
        <div class="col-md-12 mb-3">
            ...
            <select name="new_vm" id="new_vm" class="form-control" onchange="setSelectNewVM()">
        ...
        <div class="col-md-12">
            <button id="btn_update_vm" class="btn btn-primary w-100 py-2" disabled onclick="updateVM(<?php echo $_GET['id'] ?>)">Simpan</button>
        </div>
    </div>
</div>