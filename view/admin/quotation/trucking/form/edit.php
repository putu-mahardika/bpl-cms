                          ...
                          <div class="mb-3">
                            ...
                            <div class="mb-3">
                              <ul class="nav nav-tabs" id="myTab" role="tablist">
                                ...
                                <li class="nav-item">
                                  <a class="nav-link <?php $dataForm['TripType'] == 'multiTrip' ? printf('active') : printf('') ?>" id="multiTrip-tab" data-toggle="tab" href="#multiTrip" role="tab" aria-controls="multiTrip" aria-selected="false">Multi Trip</a>
                                </li>
                                <li class="nav-item">
                                  <a class="nav-link <?php $dataForm['TripType'] == 'kgm' || $dataForm['TripType'] == 'cbm' ? printf('active') : printf('') ?>" id="kgmCbm-tab" data-toggle="tab" href="#kgmCbm" role="tab" aria-controls="kgmCbm" aria-selected="false">KGM/CBM</a>
                                </li>
                              </ul>
