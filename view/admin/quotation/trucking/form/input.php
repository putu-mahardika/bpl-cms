                  ...
                  <form role="form" method="post" action="../../../../../config/controller/quotationTruckingController.php">
                    ...
                    <div class="mb-5">
                      <div class="mb-3">
                        ...
                        <div class="form-group">
                          <label>Keterangan :</label>
                          <textarea type="text" class="form-control form-control-sm mb-3" name="keterangan" id="keterangan" minlength="3" maxlength="100"></textarea>
                        </div>
                      </div>
                      <div class="mb-3">
                        <div class="form-group">
                                  ...
                                  <table class="table align-items-center table-flush table-hover">
                                    ...
                                    <tbody>
                                      <tr>
                                        ...
                                        <td>
                                          <textarea type="text" class="form-control form-control-sm mb-3" name="detailKotaAsal3" id="detailKotaAsal3" minlength="3" maxlength="100"></textarea>    
                                        </td>
                                        <td>
                                          <textarea type="text" class="form-control form-control-sm mb-3" name="detailKotaTujuan3" id="detailKotaTujuan3" minlength="3" maxlength="100"></textarea>
                                        </td>
                                      </tr>
                                    </tbody>
                                  </table>
