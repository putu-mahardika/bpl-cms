                  ...
                  <div class="col-12">
                    ...
                    <div class="form-row">
                      <div class="form-group col-md-12 col-lg-6">
                        ...
                        <select id="shipmentTerm" class="form-control form-control-sm">
                          <option selected>Choose...</option>
                          <option>...</option>
                        </select>
                      </div>
                      <div class="form-group col-md-12 col-lg-6">
                        ...
                        <select id="ShipmentLoadType" class="form-control form-control-sm">
                          <option selected>Choose...</option>
                          <option>...</option>
                        </select>
                      </div>
                    ...
                    <div class="form-row">
                      <div class="form-group col-md-12 col-lg-6">
                        ...
                        <div class="input-group input-group-sm mb-3">
                          ...
                          <input type="text" class="form-control" placeholder="0.00" aria-label="biayaFreight" id="biayaFreight" aria-describedby="basic-addon1">
                        </div>
                        <div class="form-row">
                          <div class="form-group col-md-12 col-lg-6">
