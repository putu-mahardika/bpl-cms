...
<head>
  ...
  <title>Tambah Jenis Kendaraan - PT Berkah Permata Logistik</title>
      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-start mb-4">
            ...
            <h1 class="h3 mb-0 text-gray-800">Tambah Jenis Kendaraan</h1>
            <!--<ol class="breadcrumb">
          ...
          <div class="card-body">
              <form class="form group" method="post" action="../../config/process.php">
                ...
                <label>Nama :</label>
                <input type="text" class="form-control form-control-sm mb-3" name="namaJenisKendaraan" minlength="3" maxlength="30" required>
                ...
                <input type="submit" value="Submit" name="inputJenisKendaraan" class="btn btn-md btn-primary " style="width:77%;">
              </form>
            </div>
