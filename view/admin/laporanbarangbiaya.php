      ...
      <li class="nav-item active">
        ...
        <div id="collapseReportTruck" class="collapse show" aria-labelledby="headingTable" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item active" href="laporanbarangbiaya.php">Laporan Biaya</a>
          </div>
        </div>
      </li>
      <li class="nav-item">
      ...
      dataGrid = $('#gridContainer').dxDataGrid({
        ...
        onExporting(e) {
          ...
          DevExpress.excelExporter.exportDataGrid({
            ...
            headerRow.getCell(1).value = 'Laporan DetailBiaya Pergerakan Truck - PT Berkah Permata Logistik';
