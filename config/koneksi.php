<?php
    ...
    $base_url = $_SERVER['HTTP_HOST'] == 'berkahpermatalogistik.com' ? $_SERVER['REQUEST_SCHEME'] . '://' . $_SERVER['HTTP_HOST'] . '/bpl-cms' : $_SERVER['REQUEST_SCHEME'] . '://' . $_SERVER['HTTP_HOST'] . '/bpl-cms';
